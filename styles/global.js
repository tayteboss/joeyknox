...
export const GlobalStyles = createGlobalStyle`
	/* @font-face {
		font-family: 'ReConnect-LightItalic';
		src: url('/fonts/ReConnect-LightItalic.woff2') format('woff2'), url('/fonts/ReConnect-LightItalic.woff') format('woff'), url('/fonts/ReConnect-LightItalic.ttf') format('ttf');
		font-style: italic;
		font-weight: 400;
		font-display: swap;
	}; */
